...
@section('panel_content')
    ...
    <div class="">
        ...
        @endif
        <form class="form form-horizontal mar-top" action="{{route('seller.preorder-product.update', $product->id)}}"
                            ...
                            @foreach (get_all_active_language() as $key => $language)
                                <li class="nav-item">
                                    <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3"
                                       href="{{ route('seller.preorder-product.edit', ['id' => $product->id, 'lang' => $language->code]) }}">
