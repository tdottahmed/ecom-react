...
@section('panel_content')
    ...
    <div class="">
        ...
        @endif
        <form class="form form-horizontal mar-top" action="{{route('seller.preorder-product.store')}}" method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row" id="brand">
                                <label class="col-md-3 col-from-label">{{translate('Brand')}} <span class="text-danger">*</span>
                                </label>
                                <div class="col-md-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Upload a primary image at 300x200 pixels for quick preview. [e.g. A front view of the product.]')}}</small>
                                </div>
                            </div>
                            ...
                            <div class="prepayment">
                                ...
                                <div id="prepaymentBlock" style="display: none;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" value="0" step="1"
                                                   placeholder="{{ translate('Prepay Amount') }}"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-9">
                                                    <input type="text" placeholder="{{ translate('Coupon Code') }}"
                                                           name="coupon_code" class="form-control" id="coupon_code">
                                                </div>
                                                <div class="form-group col-md-3">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class=" form-check col-md-12 ml-3">
                                    <input class="form-check-input" type="checkbox" name="show_shipping_note" value="1"
