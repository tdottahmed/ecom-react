                            ...
                            <div class="d-flex">
                                ...
                                <div class="bg-light rounded-1">
                                    ...
                                    <a href="javascript:void(0);"
                                       class="badge badge-inline {{ $type == 'all' ? $activeClasss : $inActiveClasses}}"
                                       onclick="sort_product_by_user('all')">{{ translate('All') }}</a>
                                    <a href="javascript:void(0);"
                                       class="badge badge-inline {{ $type == 'in_house' ? $activeClasss : $inActiveClasses}}"
                                       onclick="sort_product_by_user('in_house')">{{ translate('In-house') }}
                                        ({{ $inHouseProductCount }})</a>
                                    <a href="javascript:void(0);"
                                       class="badge badge-inline {{ $type == 'seller' ? $activeClasss : $inActiveClasses}}"
                                       onclick="sort_product_by_user('seller')">{{ translate('Seller’s') }}
                                        ({{ $sellerProductCount }})</a>
                                </div>
                                <div>
                                    <span
                                        class="badge badge-inline preorder-border-dashed p-3 m-2 rounded-3 text-muted fs-12 fw-600">{{ translate('Published') }}({{ $publishedProductCount }})</span>
                                    <span
                                        class="badge badge-inline preorder-border-dashed p-3 m-2 rounded-3 text-muted fs-12 fw-600">{{ translate('Unpublished') }}({{ $unpublishedProductCount }})</span>
                                    <span
                                        class="badge badge-inline preorder-border-dashed p-3 m-2 rounded-3 text-muted fs-12 fw-600">{{ translate('Discounted') }}({{ $discountedProductCount }})</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row gutters-5 ">
                                    <div class="col-auto">
                                        <img src="{{ uploaded_asset($product->thumbnail) }}" alt="Image"
                            ...
                            <td>
                                ...
                                <div>
                                    <span
                                        class="text-muted text-truncate-2 text-info">{{ translate( $product->user->user_type != 'seller' ? 'In-house' : $product->user->shop->name) }}</span>
                                    <span
                                ...
                                @if($product->is_available || $product->available_date != null)
                                    <div class="bg-soft-secondary px-4 py-2 rounded-1 mt-2">
                                        ...
                                        @elseif($product->available_date != null)
                                            ...
                                            <span
                                                class="text-muted text-truncate-2 fw-700 fs-13 text-secondary">{{strtotime($product->available_date) > strtotime(date('d-m-Y'))  ? translate('Approx') : translate('Available now') }}</span>
                                        @endif
                                    </div>
                                @endif
                            </td>
                            ...
                            <td>
                                ...
                                <div class="mb-2">
                                    <span
                                        class="opacity-60 text-muted text-truncate-2 fs-12">{{ translate('Featured') }}</span>
                                    <label class="aiz-switch aiz-switch-success mb-0 mt-2">
