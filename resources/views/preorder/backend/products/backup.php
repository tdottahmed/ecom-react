            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Weight')}} <small>({{ translate('In Kg')
                                    }})</small></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="weight" step="1" value="0.00"
                                       placeholder="0.00">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                                ...
                                <div class="col-md-9">
                                    <div class=" mb-4 row">
                                        <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="price_type"
                                                       value="fixed" onchange="" checked>
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Fixed')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="price_type"
                                                       value="not_fixed" onchange="" checked>
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Not Fixed')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="price_type"
                                                       value="later" onchange="" checked>
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Will be announced later')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="price_type"
                                                       value="call" onchange="" checked>
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Use Call for Price Sticker')}}</label>
                                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label" for="start_date">{{translate('Unit price')}} <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                        ...
                        <div class="prepayment">
                                ...
                                <div class="col-md-9">
                                    <div class=" mb-4 row">
                                        <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio"
                                                       name="prepayment_type" value="fixed" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Fixed')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio"
                                                       name="prepayment_type" value="need_for_cod" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Needed only for Cash On Delivery')}}</label>
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0" value="0" step="1"
                                           placeholder="{{ translate('Prepay Amount') }}" name="prepayment_amount"
                                           class="form-control">
                                </div>
                            </div>
                            <hr style="border-bottom: 1px dashed #e4e5eb;">
                        ...
                        <div class="sample-order">
                                ...
                                <div class="col-md-9">
                                    <div class=" mb-4 row">
                                        <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio"
                                                       name="sample_price_type" value="fixed" onchange="" checked>
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Fixed')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio"
                                                       name="sample_price_type" value="call" onchange="" checked>
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Use Call for Sample Price Sticker')}}</label>
                                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label"
                                       for="start_date">{{translate('Sample Price')}} </label>
                                <div class="col-sm-9">
                                    <input type="number" min="0" value="0" step="1"
                                           placeholder="{{ translate('Sample Price') }}" name="sample_price"
                                           class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 control-label"
                                       for="start_date">{{translate('Sample Making & Delivery Time')}} </label>
                                <div class="col-sm-9">
                                    <input type="number" min="0" value="0" step="1"
                                           placeholder="{{ translate('10 Days') }}" name="delivery_day"
                                           class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label
                                    class="col-md-3 col-from-label">{{translate('Prepayment Needed for Sample')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label"
                                       for="start_date">{{translate('Prepay Amount for Sample')}} </label>
                                <div class="col-sm-9">
                                    <input type="number" min="0" value="0" step="1" placeholder="{{ translate('100') }}"
                                           name="prepayment_amount" class="form-control" required>
                                </div>
                            </div>
                            <hr style="border-bottom: 1px dashed #e4e5eb;">
                        </div>
                                ...
                                <div class="col-md-9">
                                    <div class="row m-0 p-0">
                                        <div class="col-md-2 p-1">
                                            <input type="text" class="form-control" name="wholesale_min_qty[]"
                                                   placeholder="{{ translate('Min Quantity') }}">
                                        </div>
                                        <div class="col-md-2 p-1">
                                            <input type="text" class="form-control" name="wholesale_max_qty[]"
                                                   placeholder="{{ translate('Max Quantity') }}">
                                        </div>
                                        ...
                                        <div class="col-md-2 p-1 m-0">
                                            <input type="text" class="form-control" name="wholesale_lead_time[]"
                                                   placeholder="{{ translate('Lead Time') }}">
                                        </div>
                                        <div class="col-md-2 p-1">
                                            <a href="#"
                                               class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                               data-href="" title="{{ translate('Delete') }}">
                        ...
                        <div class="discount-settings">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-md-3 col-from-label">{{translate('Use Advance Discount Option')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label"
                                       for="start_date">{{translate('Discount On Preorder Periods')}}</label>
                                <div class="col-sm-9">
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <input type="number" min="0" value="0" step="1"
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label"
                                       for="start_date">{{translate('After Preorder Period Discount')}}</label>
                                <div class="col-sm-9">
                                    <div class="form-row">
                                        <div class="form-group col-md-9">
                                            <input type="number" min="0" value="0" step="1"
                                                   placeholder="{{ translate('Amount') }}"
                                                   name="after_preorder_discount_amount" class="form-control" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <select class="form-control aiz-selectpicker"
                                                    name="after_preorder_discount_type">
                                                <option value="amount">{{translate('Flat')}}</option>
                                                <option value="percent">{{translate('Percent')}}</option>
                                            </select>
                                        </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label"
                                       for="start_date">{{translate('Discount For Direct Purchase')}}</label>
                                <div class="col-sm-9">
                                    <div class="form-row">
                                        <div class="form-group col-md-9">
                                            <input type="number" min="0" value="0" step="1"
                                                   placeholder="{{ translate('Amount') }}"
                                                   name="direct_purchase_discount_amount" class="form-control" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <select class="form-control aiz-selectpicker"
                                                    name="direct_purchase_discount_type[]">
                                                <option value="amount">{{translate('Flat')}}</option>
                                                <option value="percent">{{translate('Percent')}}</option>
                                            </select>
                                        </div>
                        ...
                        <div class="coupons">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-md-3 col-from-label">{{translate('Show Other Counpons For This Seller')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <button class="btn btn-secondary btn-block">{{translate('Generate ')}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control aiz-date-range"
                                                   name="coupon_date_range" placeholder="{{translate('Select Date')}}"
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-md-3 col-from-label">{{translate('Use Advanced Coupon Option')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class=" mb-4 row">
                                        <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="coupon_type"
                                                       value="for_this_order" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('For this order')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="coupon_type"
                                                       value="free_delivery" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Free Delivery')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="coupon_type"
                                                       value="for_seller_store" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('For Seller Store')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="coupon_type"
                                                       value="assign_coupon" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Assign Coupons from System')}}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                            <div>
                                                <input id="fq_bought_select_products" type="radio" name="coupon_type"
                                                       value="other_benefits" onchange="">
                                                <label for="fq_bought_select_products"
                                                       class="fs-14 fw-700 mb-0 ml-2">{{translate('Other Benefits')}}</label>
                                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                       for="signinSrEmail">{{translate('Coupon Benefits')}}</label>
                                <div class="col-md-9 d-flex justify-content-between">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check1"
                                               name="coupon_benefits[]" value="gift">
                                        <label class="form-check-label" for="check1">{{translate('Gift')}}</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check2"
                                               name="coupon_benefits[]" value="service">
                                        <label class="form-check-label" for="check2">{{translate('Service')}}</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check2"
                                               name="coupon_benefits[]" value="customization">
                                        <label class="form-check-label"
                                               for="check2">{{translate('Customization')}}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-md-12 col-from-label text-orange fw-bold"><b>{{translate('Preorder Campaign')}}</b></label>
                            <div class="col-md-12">
                                <select class="form-control aiz-selectpicker" name="campaign" id="campaign"
                                        data-live-search="true">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="club_point"
                                       placeholder="{{ translate('Club Point') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="form-check col-md-12 ml-3">
                                ...
                                <label class="form-check-label" for="flexCheckChecked">
                                    <b>
                                        {{translate('Show note in cash on delivery section in product description page')}}</b>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input type="number" min="0" value="0" step="1" placeholder="{{ translate('Tax') }}"
                                       name="tax_amount[]" class="form-control" required>
                            </div>
                            <div class="form-group col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label
                                class="col-md-6 col-from-label"><b>{{translate('Stock Visibility State')}}</b></label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="stock_visibility_state"
                                           id="stock_visibility_state1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="current_stock"
                                               placeholder="{{ translate('10') }}" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label
                                        class="col-md-6 col-from-label"><b>{{translate('Low Stock Quantity Warning')}}</b></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="low_stock_stock"
                                               placeholder="{{ translate('10') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-md-6 ms-auto">
                                        <label class="aiz-switch aiz-switch-success mb-0 ms-auto">
                                            <input type="checkbox" name="is_custom_order_show" value="1"
                                                   class="ms-auto">
                                            <span></span>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-md-4 col-from-label text-orange">{{translate('Preorder Number')}}</label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="preorder_quantity"
                                               placeholder="{{ translate('10') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label
                                        class="col-md-4 col-from-label text-orange">{{translate('Final Order Number')}}</label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="final_order_quantity"
                                               placeholder="{{ translate('10') }}" required>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>
                            {{translate('This is a customised section in product description page where you can select end category or selected products as More Products to Preorder.')}}</p>
                        ...
                        <table class="table mb-0">
                            ...
                            <tr class="remove-parent">
                                ...
                                <td style="vertical-align: middle;">
                                    <p class="d-block fs-13  hov-text-primary mb-1 text-dark"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control aiz-selectpicker"
                                                ...
                                                name="fq_bought_product_category_id" data-live-search="true" required>
                                            @foreach ($categories as $category)
            ...
            <div class="col-12">
                <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group mr-2" role="group" aria-label="Third group">
                        <button type="submit" name="button" value="unpublish" class="btn btn-primary action-btn">
...
<script type="text/javascript">
            ...
            success: function (data) {
                ...
                <div class="form-group row">\
                    <div class="col-md-3">\
                        ...
                        <input type="text" class="form-control" name="choice[]" value="' + name + '" placeholder="{{ translate('
                Choice
                Title
                ') }}" readonly>\
                                    </div>\
    ...
    function addFqBoughtProduct() {
        ...
        ') }}', {_token: AIZ.data.csrf, product_ids: productIds}, function (data) {
