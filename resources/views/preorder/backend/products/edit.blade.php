...
@section('content')
    ...
    <div class="">
        ...
        @endif
        <form class="form form-horizontal mar-top" action="{{route('preorder-product.update', $product->id)}}"
                            ...
                            @foreach (get_all_active_language() as $key => $language)
                                <li class="nav-item">
                                    <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3"
                                       href="{{ route('preorder-product.edit', ['id' => $product->id, 'lang' => $language->code]) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Product Name')}}
                                    <span class="text-danger">*</span> <i class="las la-language text-danger"
                                                                          title="{{translate('Translatable')}}"></i>
                                </label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="product_name"
                                           placeholder="{{ translate('Product Name') }}"
                                           value="{{ $product->getTranslation('product_name',$lang) }}" required>
                                    <small
                                        class="text-muted">{{translate('Enter a descriptive name for the product. [e.g. "Wireless Bluetooth Headphones"]')}}</small>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id"
                                        ...
                                        @foreach ($brands as $brand)
                                            <option
                                                value="{{ $brand->id }}" @selected($brand->id == $product->brand_id)>{{ $brand->getTranslation('name') }}</option>
                                        @endforeach
                                    </select>
                                    <small
                                        class="text-muted">{{ translate('Choose the product\'s brand from the list. [e.g. "Sony"]') }}</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Specify the unit of measurement for the product. [e.g. "Piece" or "kg"]')}}</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="display: none">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Set the minimum quantity a customer must buy. [e.g. "2"]')}}</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Add keywords to help customers find this product. [e.g. "wireless, headphones, audio"]')}}</small>
                                </div>
                            </div>
                            ...
                            @if (addon_is_activated('pos_system'))
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <small
                                            class="text-muted">{{translate('Enter the product’s barcode or SKU for inventory tracking. [e.g. "1234567890123"]')}}</small>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Upload multiple images, each 600x400 pixels. [e.g. Images showing products from different angles.]')}}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Upload a primary image at 300x300 pixels for quick preview. [e.g. A front view of the product.]')}}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" name="video_provider"
                                            id="video_provider">
                                        <option
                                            value="youtube" @selected($product->video_provider == 'youtube')>{{translate('Youtube')}}</option>
                                        <option
                                            value="dailymotion" @selected($product->video_provider == 'dailymotion')>{{translate('Dailymotion')}}</option>
                                        <option
                                            value="vimeo" @selected($product->video_provider == 'vimeo')>{{translate('Vimeo')}}</option>
                                    </select>
                                    <small
                                        class="text-muted">{{translate('Select the video platform hosting the product video. [e.g. "YouTube"]')}}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{ translate('Provide the link to the product video. [e.g. "https://www.youtube.com/watch?v=12345"]') }}</small>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Write a detailed overview of the product, including features. [e.g. "These wireless Bluetooth headphones offer premium sound quality, noise cancellation, and a comfortable design for all-day use."]')}}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label" for="start_date">{{translate('Unit price')}}
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <small
                                            class="text-muted">{{translate('Enter the price per unit. [e.g. "$49.99"]')}}</small>
                                    </div>
                                </div>
                            ...
                            <div class="prepayment">
                                ...
                                <div id="prepaymentBlock"
                                     style="display: {{$product->is_prepayment ? 'block' : 'none' }};">

                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label"
                                               for="start_date">{{translate('Prepay Amount')}} </label>
                                        <div class="col-sm-9">
                                            ...
                                            <small
                                                class="text-muted">{{translate('Specify the required prepayment amount for pre-orders. [e.g. "$10.00"]')}}</small>
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-bottom: 1px dashed #e4e5eb;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control aiz-date-range" name="date_range"
                                               @if($product->discount_start_date && $product->discount_end_date) value="{{ $start_date.' to '.$end_date }}"
                                               @endif
                                               placeholder="{{translate('Select Date')}}" data-time-picker="true"
                                               data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                                        <small
                                            class="text-muted">{{translate('Choose start and end dates for a discount period. [e.g. "01/01/2024 - 01/15/2024"]')}}</small>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label"
                                           for="start_date">{{translate('Discount')}}</label>
                                    <div class="col-sm-9">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select class="form-control aiz-selectpicker" name="discount_type">
                                                    <option
                                                        value="flat" @selected($product->discount_type == 'flat')>{{translate('Flat')}}</option>
                                                    <option
                                                        value="percent" @selected($product->discount_type == 'percent')>{{translate('Percent')}}</option>
                                                </select>
                                            </div>
                                            <small
                                                class="text-muted">{{translate('Specify the discount percentage or amount. [e.g. "10%" or "$5.00"]')}}</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="coupons">
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-md-3 col-from-label">{{translate('Use Coupon For This Product')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                ...
                                <div id="couponBlock" style="display: {{$product->is_coupon ? 'block' : 'none' }}">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label"
                                               for="start_date">{{translate('Coupon Code')}}</label>
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="form-group col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-md-3 col-from-label">{{translate('Coupon Date Range')}}</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control aiz-date-range"
                                                   name="coupon_date_range"
                                                   @if($coupon?->coupon_start_date && $coupon?->coupon_end_date) value="{{ $start_date.' to '.$end_date }}"
                                                   @endif
                                                   placeholder="{{translate('Select Date')}}" data-time-picker="true"
                                                   data-format="DD-MM-Y HH:mm:ss" data-separator=" to "
                                                   autocomplete="off">
                                            <small
                                                class="text-muted">{{translate('Choose start and end dates for a coupon discount period. [e.g. "01/01/2024 - 01/15/2024"]')}}</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-row">
                                                <div class="form-group col-md-9">
                                                    <input type="number" min="0" value="{{$coupon?->coupon_amount}}"
                                                           step="1"
                                                ...
                                                <div class="form-group col-md-3">
                                                    <select class="form-control aiz-selectpicker" name="coupon_type">
                                                        <option
                                                            value="flat" @selected($coupon?->coupon_type == 'flat')>{{translate('Flat')}}</option>
                                                        <option
                                                            value="percent" @selected($coupon?->coupon_type == 'percent')>{{translate('Percent')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <small
                                                class="text-muted">{{translate('Specify the coupon amount percentage or amount. [e.g. "10%" or "$5.00"]')}}</small>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Add a title for SEO purposes to improve search visibility. [e.g. "Premium Wireless Bluetooth Headphones"]')}}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Provide a short SEO-friendly description. [e.g. "High-quality Bluetooth headphones with noise cancellation."]')}}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small
                                        class="text-muted">{{translate('Upload an image that represents the product in search engines. [e.g. A high-resolution image of the product.]')}}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="is_published"
                                               value="1" {{ $product->is_published == 1 ? 'checked' : '' }}>
                                        <span></span>
                                    </label>
                                </div>
                                <small
                                    class=" col-md-12 col-from-label text-muted">{{translate('Upload an image that represents the product in search engines. [e.g. A high-resolution image of the product.]')}}</small>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="is_featured"
                                               value="1" {{ $product->is_featured == 1 ? 'checked' : '' }}>
                                        <span></span>
                                    </label>
                                </div>
                                <small
                                    class=" col-md-12 col-from-label text-muted">{{translate('Toggle to mark this product as featured on the platform.')}}</small>
                                ...
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" id="is_available" name="is_available"
                                               value="1" {{ $product->is_available == 1 ? 'checked' : '' }}>
                                        <span></span>
                                    </label>
                                </div>
                            ...
                            <div class="form-group row" id="available_date_group"
                                 style="{{ $product->is_available == 1 ? 'display: none;' : 'display: flex;' }}">
                                <label class="col col-from-label">{{translate('Available From')}}</label>
                                <div class="col col-from-label">
                                    <input type="date" class="form-control aiz-date" name="available_date"
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="is_refundable" value="1"
                                                   id="is_refundable" {{ $product->is_refundable == 1 ? 'checked' : '' }}>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div id="refundBlock"
                                     style="display: {{ $product->is_refundable == 1 ? 'block' : 'none' }}">
                                    <div class="form-group row">
                                        <div class="form-check col-md-12 ml-3">
                                            <input class="form-check-input" type="checkbox" name="show_refund_note"
                                                   value="1"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row" id="show_shipping_days_block"
                                 style="display: {{ $product->is_cod == 1 ? 'block' : 'none' }}">
                                <div class="form-group row d-flex">
                                    <div class="form-check col-md-6">
                                        <label for="name">{{translate('Minimum Shipping Days')}}</label>
                                        <input type="text" class="form-control" name="min_shipping_days"
                                               placeholder="{{ translate('write in days') }}"
                                               value="{{$shipping?->min_shipping_days}}">
                                    </div>
                                    <div class="form-check col-md-6 ">
                                        <label for="name">{{translate('Maximum Shipping Days')}}</label>
                                        <input type="text" class="form-control" name="max_shipping_days"
                                               placeholder="{{ translate('write in days') }}"
                                               value="{{$shipping?->max_shipping_days}}">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label
                                    class="col-md-6 col-from-label">{{translate('Cash on delivery available')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            <div id="codBlock" style="display: {{ $product->is_cod == 1 ? 'block' : 'none' }}">
                                <div class="form-group row">
                                    <div class="form-check col-md-12 ml-3" id="prepayment_needed_for_cod"
                                         style="display: {{ $product->is_prepayment == 1 ? 'block' : 'none' }}">
                                        <input class="form-check-input" type="checkbox" value="1"
                                               name="prepayment_needed" {{ $cod?->prepayment_needed == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group row">
                                    <div class="form-check col-md-12 ml-3">
                                        <input class="form-check-input" type="checkbox" value="1"
                                               name="show_cod_note" {{ $cod?->show_cod_note == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexCheckChecked">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <input type="number" min="0" value="{{$tax->tax}}" step="1"
                                               placeholder="{{ translate('Tax') }}" name="tax_amount[]"
                                               class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <select class="form-control aiz-selectpicker" name="tax_type[]">
                                            <option
                                                value="amount" @selected($tax->tax_type == 'amount')>{{translate('Flat')}}
                                            </option>
                                    ...
                                    <small
                                        class="col-md-12 col-from-label text-muted">{{translate('Enter the vat & tax rate percentage for this product. [e.g. "8%"]')}}</small>
                                </div>
                            @endforeach
                        </div>
                    </div>
                                                    ...
                                                    <table class="table mb-0">
                                                        ...
                                                        @foreach($more_products as $more_product)
                                                            <tr class="remove-parent">
                                                                <input type="hidden" name="pre_order_product_ids[]"
                                                                       value="{{ $more_product->id }}">
                                                                <td class="w-150px pl-0"
                                                                    style="vertical-align: middle;">
                                                                    <p class="d-block size-48px">
                                                                        <img
                                                                            src="{{ uploaded_asset($more_product->thumbnail) }}"
                                                                            alt="{{ translate('Image')}}"
                                                            ...
                                                            @foreach($fq_bought_products as $fQBproduct)
                                                                <tr class="remove-parent">
                                                                    ...
                                                                    <td class="w-150px pl-0"
                                                                        ...
                                                                        <p class="d-block size-48px">
                                                                            <img
                                                                                src="{{ uploaded_asset($fQBproduct->thumbnail_img) }}"
                                                                                alt="{{ translate('Image')}}"
                                                                                class="h-100 img-fit lazyload"
                                                                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                                                        </p>
                    ...
                    <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group mr-2" role="group" aria-label="Third group">
                            <button type="submit" name="button"
                                    class="btn btn-success action-btn">{{translate('Update Product') }}</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function filterPreOrderProduct() {
            ...
            $.post('{{ route('preorder_product.search') }}', {
                _token: AIZ.data.csrf,
                product_id: null,
                search_key: searchKey,
        ...
        function addPreOrderProduct() {
            ...
            $.post('{{ route('get-selected-preorder-products') }}', {
                _token: AIZ.data.csrf,
                product_ids: productIds
            }, function (data) {
