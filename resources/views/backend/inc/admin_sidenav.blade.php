  ...
  <div class="aiz-sidebar left c-scrollbar">
    ...
    <div class="aiz-side-nav-wrap">
      <div class="position-relative mb-3 px-3">
        <input class="form-control rounded-2 form-control-sm fs-14 bg-transparent text-white" type="text"
               name="" placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()">
        <span class="absolute-top-right mr-3 pr-3" style="margin-top: 10px;">
      ...
      <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
        ...
        @canany(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
          ...
          'view_all_brands', 'brand_bulk_upload', 'view_product_attributes', 'view_colors', 'view_product_warranties',
              ...
              @can('view_product_warranties')
                <li class="aiz-side-nav-item">
                  <a href="{{ route('warranties.index') }}"
                     class="aiz-side-nav-link {{ areActiveRoutes(['warranties.edit']) }}">
              ...
              @can('view_product_reviews')
                <li class="aiz-side-nav-item">
                  <a href="{{ route('reviews.index') }}"
                     class="aiz-side-nav-link {{ areActiveRoutes(['detail-reviews', 'custom-review.edit']) }}">
        ...
        @if (addon_is_activated('preorder'))
          @canany(['preorder_dashboard', 'add_preorder_product', 'view_all_preorder_products', 'view_all_preorders',
            'view_all_inhouse_preorders', 'view_all_seller_preorders', 'view_all_delayed_prepayment_preorders',
            'view_all_final_preorders', 'view_preorder_seller_commission_history', 'preorder_settings',
            ...
            <li class="aiz-side-nav-item">
              ...
              <ul class="aiz-side-nav-list level-2">
                @can('preorder_dashboard')
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('preorder.dashboard') }}" class="aiz-side-nav-link">
                      <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
                    </a>
                  </li>
                @endcan
                @can('add_preorder_product')
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('preorder-product.create') }}" class="aiz-side-nav-link">
                      <span class="aiz-side-nav-text">{{ translate('Add New Preorder products') }}</span>
                    </a>
                  </li>
                @endcan
                @can('view_all_preorder_products')
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('preorder-product.index') }}"
                       class="aiz-side-nav-link {{ areActiveRoutes(['preorder-product.edit']) }}">
                      <span class="aiz-side-nav-text">{{ translate('Preorder Products') }}</span>
                    </a>
                  </li>
                @endcan
                @canany(['view_all_preorders', 'view_all_inhouse_preorders', 'view_all_seller_preorders',
                  ...
                  <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-3">
                      @php
                        ...
                        // Clone the original query to preserve it
                        $all_preorders = \App\Models\Preorder::where('is_viewed', 0);
                        // Get the total count of all preorders (before any modification)
                        $all_preorders_count = $all_preorders->count();
                        // Clone the query for product_owner_id modifications
                        $all_preorders_for_inhouse = clone $all_preorders;
                        $inhouse_preorders_count = $all_preorders_for_inhouse
                            ->where('product_owner_id', $adminId)
                            ->count();
                        $all_preorders_for_sellers = clone $all_preorders;
                        $sellers_preorders_count = $all_preorders_for_sellers
                            ->where('product_owner_id', '!=', $adminId)
                            ->count();
                        $all_delayed_prepayment_preorders = clone $all_preorders;
                        $delayed_prepayment_preorders_count = $all_preorders
                            ->where('prepayment_confirm_status', 0)
                            ...
                            ->count();
                        $all_delayed_final_orders = clone $all_preorders;
                        $delayed_final_orders_count = $all_preorders
                            ->whereHas('preorder_product', function ($query) {
                                $query->where('is_available', 1);
                            })
                            ->where(function ($query) {
                                $query
                                    ->whereHas('preorder_product', function ($subQuery) {
                                    ...
                                    ->orWhere(function ($subQuery) {
                                        ...
                                        $subQuery
                                            ->whereHas('preorder_product', function ($innerQuery) {
                      ...
                      @endcan
                      @can('view_all_inhouse_preorders')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('inhouse_preorder.list') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Inhouse Orders') }} <span
                                    class="badge badge-info ml-1">{{ $inhouse_preorders_count ?: '' }}</span></span>
                          </a>
                        </li>
                      @endcan
                      @can('view_all_seller_preorders')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('seller_preorder.list') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Seller Orders') }} <span
                                    class="badge badge-info ml-1">{{ $sellers_preorders_count ?: '' }}</span></span>
                          </a>
                        </li>
                      @endcan
                      @can('view_all_delayed_prepayment_preorders')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('delayed_prepayment_preorders.list') }}" class="aiz-side-nav-link">
                      ...
                      @endcan
                      @can('view_all_final_preorders')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('delayed_final_orders.list') }}" class="aiz-side-nav-link">
                ...
                @can('preorder_settings')
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('preorder-settings') }}"
                       class="aiz-side-nav-link {{ areActiveRoutes(['faqs.create', 'faq.edit']) }}">
                      <span class="aiz-side-nav-text">{{ translate('Preorder Settings') }}</span>
                    </a>
                  </li>
                @endcan
                @can('view_all_preorder_product_conversations')
                  @if (get_setting('conversation_system') == 1)
                    ...
                    <li class="aiz-side-nav-item">
                      <a href="{{ route('preorder-conversations.admin_index') }}"
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Preorder Product Conversation') }}</span>
                  ...
                  @endif
                @endcan
                @can('view_all_preorder_product_queries')
                  @if (get_setting('product_query_activation') == 1)
                    <li class="aiz-side-nav-item">
                      <a href="{{ route('preorder.product_query.index') }}"
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Preorder Product Queries') }}</span>
                      </a>
                    </li>
                  @endif
                @endcan
                @can('view_all_preorder_product_reviews')
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('preorder.product_reviews.index') }}"
                       class="aiz-side-nav-link {{ areActiveRoutes(['preorder.product_detail_reviews']) }}">
                      <span class="aiz-side-nav-text">{{ translate('Preorder Product Reviews') }}</span>
                    </a>
                  </li>
                @endcan
                @can('view_all_faqs')
        ...
        @if (addon_is_activated('auction'))
          @canany(['add_auction_product', 'view_all_auction_products', 'view_inhouse_auction_products',
            'view_seller_auction_products', 'view_auction_product_orders'])
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
        ...
        @if (addon_is_activated('wholesale'))
          @canany(['add_wholesale_product', 'view_all_wholesale_products', 'view_inhouse_wholesale_products',
            'view_sellers_wholesale_products'])
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        @if (addon_is_activated('delivery_boy'))
          @canany(['view_all_delivery_boy', 'add_delivery_boy', 'delivery_boy_payment_history',
            ...
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
                  <svg id="Group_28285" data-name="Group 28285" xmlns="http://www.w3.org/2000/svg" width="16"
          ...
          @canany(['view_refund_requests', 'view_approved_refund_requests', 'view_rejected_refund_requests',
            ...
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    <path id="_4436b8ef9250481406399210799cb7f1" data-name="4436b8ef9250481406399210799cb7f1"
                ...
                @can('view_refund_requests')
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('refund_requests_all') }}"
                       class="aiz-side-nav-link {{ areActiveRoutes(['refund_requests_all', 'admin.reason_show']) }}">
        ...
        @if (get_setting('vendor_system_activation') == 1)
          @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
            'seller_commission_configuration', 'view_all_seller_packages', 'seller_verification_form_configuration',
            'set_category_wise_commission', 'set_seller_based_commission'])
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        <!-- Reports -->
        @canany(['earning_report', 'in_house_product_sale_report', 'seller_products_sale_report',
          'products_stock_report', 'product_wishlist_report', 'user_search_report', 'commission_history_report',
        ...
        <!-- marketing -->
        @canany(['view_all_flash_deals', 'view_all_dynamic_popups', 'view_all_custom_alerts', 'manage_email_templates',
          'send_newsletter', 'notification_settings', 'view_all_notification_types', 'send_custom_notification',
          'view_custom_notification_history', 'send_bulk_sms', 'view_all_subscribers', 'view_all_coupons'])
          <li class="aiz-side-nav-item">
            <a href="#" class="aiz-side-nav-link">
              <div class="aiz-side-nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
            ...
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    <path id="pin-code"
                          d="M4.25,12.25a.625.625,0,0,1,.625.625h0a.625.625,0,1,1-1.25,0h0A.625.625,0,0,1,4.25,12.25Zm1.875.625h0a.625.625,0,1,0,1.25,0h0a.625.625,0,1,0-1.25,0Zm2.5,0h0a.625.625,0,1,0,1.25,0h0a.625.625,0,1,0-1.25,0Zm2.5,0h0a.625.625,0,1,0,1.25,0h0a.625.625,0,0,0-1.25,0Zm3-3.046a.625.625,0,0,0-.312,1.211,1.249,1.249,0,0,1,.937,1.211V13.5a1.251,1.251,0,0,1-1.25,1.25H2.5A1.251,1.251,0,0,1,1.25,13.5V12.25a1.257,1.257,0,0,1,.9-1.2.625.625,0,1,0-.354-1.2,2.518,2.518,0,0,0-1.284.888A2.478,2.478,0,0,0,0,12.25V13.5A2.5,2.5,0,0,0,2.5,16h11A2.5,2.5,0,0,0,16,13.5V12.25A2.5,2.5,0,0,0,14.125,9.829Zm-10.562-.7V5.749A1.877,1.877,0,0,1,5.437,3.874h.124V2.387a2.438,2.438,0,0,1,4.875,0V3.874h.126a1.877,1.877,0,0,1,1.875,1.875V9.124A1.877,1.877,0,0,1,10.562,11H5.437A1.877,1.877,0,0,1,3.562,9.124Zm3.249-5.25H9.187V2.387a1.189,1.189,0,0,0-2.375,0V3.874Zm-2,5.25a.626.626,0,0,0,.625.625h5.125a.626.626,0,0,0,.625-.625V5.749a.626.626,0,0,0-.625-.625H5.437a.626.626,0,0,0-.625.625ZM8,8.125A.625.625,0,0,0,8.625,7.5h0a.625.625,0,0,0-1.25,0h0A.625.625,0,0,0,8,8.125Z"
        ...
        @canany(['payment_methods_configurations', 'african_pg_configuration', 'african_pg_credentials_configuration',
          'view_all_manual_payment_methods', 'view_all_offline_payment_orders', 'view_all_offline_wallet_recharges',
          'view_all_offline_customer_package_payments', 'view_all_offline_seller_package_payments',
          'asian_payment_gateway_configuration'])
          <li class="aiz-side-nav-item">
            ...
            <ul class="aiz-side-nav-list level-2">
              ...
              @if (addon_is_activated('offline_payment'))
                @canany(['view_all_manual_payment_methods', 'view_all_offline_payment_orders',
                  'view_all_offline_wallet_recharges', 'view_all_offline_customer_package_payments',
        ...
        @canany(['general_settings', 'features_activation', 'language_setup', 'currency_setup', 'vat_&_tax_setup',
          'pickup_point_setup', 'smtp_settings', 'payment_methods_configurations', 'order_configuration',
          'file_system_&_cache_configuration', 'social_media_logins', 'facebook_chat', 'facebook_comment',
          'analytics_tools_configuration', 'google_recaptcha_configuration', 'google_map_setting',
          'google_firebase_setting', 'shipping_configuration', 'shipping_country_setting', 'manage_shipping_states',
          ...
          <li class="aiz-side-nav-item">
            ...
            <ul class="aiz-side-nav-list level-2">
              ...
              @can('social_media_logins')
                <li class="aiz-side-nav-item">
                  <a href="{{ route('courier_setup.index') }}" class="aiz-side-nav-link">
                    <span class="aiz-side-nav-text">{{ translate('Curier Setup') }}</span>
                  </a>
                </li>
              @endcan
              ...
              @endcanany
              @canany(['analytics_tools_configuration', 'google_recaptcha_configuration', 'google_map_setting',
