                ...
                @if(addon_is_activated('auction'))
                    @canany(['add_auction_product','view_all_auction_products','view_inhouse_auction_products','view_seller_auction_products','view_auction_product_orders'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <div class="aiz-side-nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.964" height="16"
                            ...
                            <div class="aiz-side-nav-icon">
                                <svg id="stats_3916778" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <path id="Path_40739" data-name="Path 40739"
                                          d="M16,16H2a2,2,0,0,1-2-2V0H1.333V14A.667.667,0,0,0,2,14.667H16Z"
                                          fill="#575b6a"/>
                ...
                'view_all_coupons'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <g id="_8dbc7a38f7bdee3f0be2c44d010760a2"
                                       data-name="8dbc7a38f7bdee3f0be2c44d010760a2"
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('manage_email_templates')
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('email-templates.index', 'admin') }}"
                                               class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text">{{translate('Admin Templates')}}</span>
                                            </a>
                                        </li>
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('email-templates.index', 'seller') }}"
                                               class="aiz-side-nav-link">
                                        ...
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('email-templates.index', 'all') }}"
                                               class="aiz-side-nav-link">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('support_ticket.admin_index') }}"
                                       class="aiz-side-nav-link {{ areActiveRoutes(['support_ticket.admin_index', 'support_ticket.admin_show'])}}">
                                        ...
                                        @if($support_ticket > 0)
                                            <span class="badge badge-info">{{ $support_ticket
                                        }}</span>
                                        @endif
                                    </a>
                                </li>
                                        ...
                                        <g id="Group_28316" data-name="Group 28316"
                                           transform="translate(19317.551 -1973.449)">
                                            ...
                                            <g id="LWPOLYLINE-3" data-name="LWPOLYLINE"
                                               transform="translate(5.239 1.075)">
                                            ...
                                            <g id="LWPOLYLINE-4" data-name="LWPOLYLINE"
                                               transform="translate(1.097 1.075)">
                                            ...
                                            <g id="LWPOLYLINE-5" data-name="LWPOLYLINE"
                                               transform="translate(1.097 5.261)">
