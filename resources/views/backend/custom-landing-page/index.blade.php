    ...
    <div class="card">
        <div class="card-body">
            <table class="table aiz-table mb-0">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                               href="{{ route('custom-landing-pages.edit', $page->id) }}"
                               title="{{ translate('Edit') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                               href="{{ route('custom-landing-pages.show', $page->id) }}"
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center text-muted">{{ translate('No pages found') }}</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
