                        ...
                        <td class="d-flex justify-content-center align-items-center">
                            ...
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input id="seller_product_discount_{{ $category->id }}" type="checkbox"
                                       onchange="trigger_alert_switch(this, '{{ $key }}')"
                                    {{ $allMatch ? 'checked' : '' }}>
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" class="form-control" id="discount_{{ $category->id }}" step="0.01"
                                       value="{{$category->discount}}" min="0" placeholder="{{translate('Discount')}}"
            ...
            <div class="modal-content p-2rem">
                <div class="modal-body text-center">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-warning rounded-2 mt-2 fs-13 fw-700 w-250px"
                                onclick="confirmSettingChange()">Confirm
                        </button>
                    </div>
                </div>
            </div>
