        ...
        @if (Route::currentRouteName() == 'offline_payment_orders.index')
          <div class="col-lg-2 ml-auto">
            <select class="form-control aiz-selectpicker" name="order_type" id="order_type">
              ...
              <option value="inhouse_orders" @if ($order_type == 'inhouse_orders') selected @endif>
                {{ translate('Inhouse Orders') }}</option>
              <option value="seller_orders" @if ($order_type == 'seller_orders') selected @endif>
                {{ translate('Seller Orders') }}</option>
            </select>
          </div>
        @endif
        ...
        <table class="aiz-table mb-0 table">
          <thead>
            <tr>
              ...
              <th data-breakpoints="md">{{ translate('customer History') }}</th>
                ...
                <tr>
                  ...
                  <td>
                    @if ($order->orderShipment)
                      ...
                      @endphp
                      <span
                            class="badge badge-inline @if ($latestShipment->status == 'delivered') badge-success
                    ...
                    @else
                      <span class="badge badge-inline badge-secondary">{{ translate('Not Shipped') }}</span>
                    @endif
                  </td>
                  ...
                  <td>
                    ...
                    @else
                      <a href="{{ route('order.checkFraud', $order->id) }}" class="btn btn-soft-info btn-sm">
                        Check Histories
                  ...
                  <td>
                    @if ($order->orderShipment && ($order->orderShipment->carier = 'steadfast'))
                  ...
                  <td class="text-right">
                    ...
                    <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                       href="{{ route('invoice.download', $order->id) }}" title="{{ translate('Download Invoice') }}">
