...
@section('content')
    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        ...
        <div class="alert alert-info my-2 text-center">
            <p class="pt-2 font-weight-bold">If you set commission on the main Category, All the sister category will
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" class="form-control" id="commission_{{ $category->id }}"
                                       step="0.01" value="{{$category->commision_rate}}" min="0"
