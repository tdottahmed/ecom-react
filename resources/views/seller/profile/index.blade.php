...
@section('panel_content')
  ...
  <form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="h6 mb-0">{{ translate('Basic Info') }}</h5>
      </div>
      <div class="card-body">
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="h6 mb-0">{{ translate('Payment Setting') }}</h5>
      </div>
      <div class="card-body">
        <div class="row">
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="h6 mb-0">{{ translate('Address') }}</h5>
    </div>
    <div class="card-body">
      <div class="row gutters-10">
        @foreach ($addresses as $key => $address)
          <div class="col-lg-4">
            <div class="position-relative mb-3 rounded border p-3 pr-5">
              <div>
              ...
              @if ($address->set_default)
                <div class="position-absolute bottom-0 right-0 pb-3 pr-2">
        ...
        <div class="col-lg-4 mx-auto" onclick="add_new_address()">
          <div class="c-pointer bg-light mb-3 rounded border p-3 text-center">
  ...
  <form action="{{ route('user.change.email') }}" method="POST">
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="h6 mb-0">{{ translate('Change your email') }}</h5>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-2">
          ...
          <div class="modal-body">
            <div class="p-3">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <select class="form-control aiz-selectpicker mb-3" data-live-search="true" name="state_id" required>
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <select class="form-control aiz-selectpicker mb-3" data-live-search="true" name="city_id" required>
